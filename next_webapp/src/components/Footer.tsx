              ...
              <div className="w-full xl:min-w-[280px] flex flex-col gap-1">
                ...
                >
                  ...
                  <input
                    ...
                    className="flex-1 min-w-0 rounded-lg px-2.5 py-1.5 text-white placeholder:text-white outline-none transition shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]"
                    style={{
                      fontSize: '0.85rem',
